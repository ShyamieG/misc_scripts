...
# This script requires 1) A PLINK .bim file and returns the number of bases that the file spans
#
# USAGE EXAMPLE:
# $ Rscript calc_genome_length.R dat_autosomes_HWE-MAFfiltered.bim
